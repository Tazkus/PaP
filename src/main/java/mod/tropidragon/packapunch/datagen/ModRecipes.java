...
// ShapedRecipeBuilder
// .shaped(RecipeCategory.MISC, ModItems.ARTIFICIAL_115.get())
// .pattern(" # ")
// .pattern("#X#")
// .pattern(" # ")
...
// ShapedRecipeBuilder
// .shaped(RecipeCategory.MISC, ModItems.ELEMENT_115.get())
// .pattern("###")
// .pattern("###")
// .pattern("###")
...
// ShapedRecipeBuilder
// .shaped(RecipeCategory.MISC, ModBlocks.RETROFIT_MACHINE.get())
// .pattern("III")
// .pattern("IXI")
// .pattern("NNN")
...
// ShapedRecipeBuilder
// .shaped(RecipeCategory.MISC, ModBlocks.ARSENAL_MACHINE.get())
// .pattern("IGI")
// .pattern("IGI")
// .pattern("IAI")
// // .define('X', ModItems.ELEMENT_115.get())
...
// .shapeless(RecipeCategory.MISC, ModItems.LIQUID_115.get(), 9)
// .requires(ModItems.ARTIFICIAL_115.get())
// .unlockedBy("has_ore", has(Tags.Items.ORES_DIAMOND))
// .save(consumer);

// ShapelessRecipeBuilder
// .shapeless(RecipeCategory.MISC, ModItems.COLA_DEADSHOT.get(), 3)
...
// ShapelessRecipeBuilder
// .shapeless(RecipeCategory.MISC, ModItems.COLA_PHD.get(), 3)
// .requires(ModItems.LIQUID_115.get(), 1)
